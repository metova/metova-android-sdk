...
public abstract class AbstractList extends AbstractCollection implements List {
    ...
    private static final class SubAbstractListRandomAccess extends SubAbstractList implements RandomAccess {
        ...
        public SubAbstractListRandomAccess(AbstractList list, int start, int end) {
    ...
    private static class SubAbstractList extends AbstractList {
        ...
        private static final class SubAbstractListIterator implements ListIterator {
            ...
            public SubAbstractListIterator(ListIterator it, SubAbstractList list, int offset, int length) {
        ...
        public SubAbstractList(AbstractList list, int start, int end) {
