...
public abstract class AbstractCollection implements Collection {
    ...
    /**
     * Make it easy to use RIM's vector as well.
     * 
     * @param vector
     * @return
     */
    public boolean addAll( java.util.Vector vector ) {
        ...
        return addAll( vector.elements() );
    }

    public boolean addAll( java.util.Hashtable hashTable ) {

        return addAll( hashTable.elements() );
    }

    public boolean addAll( Iterator iterator ) {
    ...
    public boolean addAll( Enumeration enumerator ) {

        boolean result = false;

        while (enumerator.hasMoreElements()) {

            if ( add( enumerator.nextElement() ) ) {
    ...
    public Object[] toArray( Object[] contents ) {
        ...
        while (iterator.hasNext()) {
            contents[index++] = (Object) iterator.next();
        }
