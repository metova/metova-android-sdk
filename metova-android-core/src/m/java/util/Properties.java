...
//import java.util.Hashtable;
//
//import org.metova.bb.util.io.IOUtility;
...
public class Properties extends Hashtable {
    ...
    public synchronized void load( InputStream inStream ) throws IOException {
        ...
        //Reader in = new InputStreamReader( inStream, "8859_1" );            
        String content = IOUtility.getInputStreamAsString( inStream );
            ...
            if (line.length() > 0) {
                ...
                if (( firstChar != '#' ) && ( firstChar != '!' )) {
                    while (continueLine( line )) {
                        ...
                        String nextLine = tokenizer.hasMoreTokens() ? tokenizer.nextToken() : null;
                        if (nextLine == null)
                            nextLine = "";
