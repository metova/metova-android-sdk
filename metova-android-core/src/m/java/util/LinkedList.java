...
public class LinkedList extends AbstractSequentialList implements List, Queue {
    ...
    private static final class Link {
        ...
        public Link(Object o, Link p, Link n) {
    ...
    private static final class LinkIterator implements ListIterator {
        ...
        public LinkIterator(LinkedList object, int location) {
    ...
    public Object[] toArray( Object[] contents ) {
        ...
        Link link = voidLink.next;
        while (link != voidLink) {
            contents[index++] = (Object) link.data;
            link = link.next;
        }
    ...
    //        Link link = voidLink;
    //        for (int i = size; --i >= 0;) {
    //            Link nextLink = new Link((Object) stream.readObject(), link, null);
    //            link.next = nextLink;
    //            link = nextLink;
    //        }
    //        link.next = voidLink;
