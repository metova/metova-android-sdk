...
public class BundleChecker {
    ...
    /**
     * Convenience method for retrieving an object (no primitives) from a {@link android.os.Bundle}.
     * If more than one of the Bundles passed contains an entry with the given key, the first object found is returned.
     * <p>An {@link java.lang.IllegalArgumentException} is thrown if there is no entry with the given key.
     *
     ...
     * @param bundles - an array of {@link android.os.Bundle} to look for an entry with the given <b>key</b>
